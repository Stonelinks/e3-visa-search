...
import {
  CACHE_CRON_INTERVAL_MS,
  CACHE_FOLDER,
  CACHE_MAX_AGE_DAYS,
} from "../common/constants";
import { localNow } from "../common/time";
...
export const CacheSaveCronJob = {
  name: "cache save",
  intervalMs: CACHE_CRON_INTERVAL_MS / 2,
  fn: async () => {
    saveCaches();
  },
};
...
export const CacheCleanCronJob = {
  name: "cache clean",
  intervalMs: CACHE_CRON_INTERVAL_MS,
  fn: async () => {
